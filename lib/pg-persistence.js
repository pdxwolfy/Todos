...
module.exports = class PgPersistence {
  ...
  async createTodo(todoTitle, todoListId) {
    const INSERT_TODO = "INSERT INTO todos (title, todolist_id, username) VALUES ($1, $2, $3)";

    let result = await dbQuery(INSERT_TODO, todoTitle, todoListId, this.username);
